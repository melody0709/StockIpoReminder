...
> 历史基线说明:本报告是对 `58c8df7` / `0.3.1` 的审查记录,其中的版本号、行号和产物哈希均为该基线的事实,按原样保留,不随后续版本更新。当前版本以 `Cargo.toml` 为准(2026-09-20 复核时为 `0.4.2`),0.3.2 之后的行为变化见 `CHANGELOG.md` 与 `RELEASE_NOTES.md`。
