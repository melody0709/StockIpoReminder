...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%CD%\scripts\build-release.ps1" -PackageMode "!MODE!" !SKIP_TESTS!
if errorlevel 1 exit /b !ERRORLEVEL!
...
:usage
echo Usage: build.bat [--clean^|--rebuild] [--package^|--package-msi^|--package-portable]
